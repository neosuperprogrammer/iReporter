...
-(id)initWithIndex:(int)i andData:(NSDictionary*)data {
    ...
    if (self !=nil) {
        ...
        //add touch event
        [self addTarget:self.delegate action:@selector(didSelectPhoto:) forControlEvents:UIControlEventTouchUpInside];
...
//        NSURLRequest *request = [NSURLRequest requestWithURL:imageURL];
        ...
        [thumbView setImageWithURL:imageURL];
        
//        [thumbView setImageWithURLRequest:request placeholderImage:nil success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *image) {
